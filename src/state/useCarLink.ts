...
export function useCarLink({ applyTelemetry, hydrateTelemetry, getActiveState }: UseCarLinkOptions): CarLink {
  ...
  const cacheInfotainment = useCallback((patch: Partial<VehicleViewState>) => {
    ...
    const next: CarLinkCache = {
      ...
      climateOn: patch.climateOn ?? base.climateOn,
      frontDefrostOn: patch.frontDefrostOn ?? base.frontDefrostOn,
      rearDefrostOn: patch.rearDefrostOn ?? base.rearDefrostOn,
      bioweaponOn: patch.bioweaponOn ?? base.bioweaponOn,
      climateKeeper: patch.climateKeeper ?? base.climateKeeper,
      copActivelyCooling: patch.copActivelyCooling ?? base.copActivelyCooling,
      cabinOverheatMode: patch.cabinOverheatMode ?? base.cabinOverheatMode,
      cabinOverheatTemp: patch.cabinOverheatTemp ?? base.cabinOverheatTemp,
      locked: patch.locked ?? base.locked,
      sentryEnabled: patch.sentryEnabled ?? base.sentryEnabled,
      lowPowerMode: patch.lowPowerMode ?? base.lowPowerMode,
      keepAccessoryPower: patch.keepAccessoryPower ?? base.keepAccessoryPower,
      ...
      rightFrontWindowOpen: patch.rightFrontWindowOpen ?? base.rightFrontWindowOpen,
      leftRearWindowOpen: patch.leftRearWindowOpen ?? base.leftRearWindowOpen,
      rightRearWindowOpen: patch.rightRearWindowOpen ?? base.rightRearWindowOpen,
      seatClimateModes: patch.seatClimateModes ?? base.seatClimateModes,
  ...
  const stampRead = useCallback((patch: Partial<VehicleViewState>, at: number) => {
    ...
    const next: CarLinkCache = {
      ...(cacheRef.current ?? {
        ...
        bioweaponOn: null,
        climateKeeper: null,
        copActivelyCooling: null,
        cabinOverheatMode: null,
        cabinOverheatTemp: null,
        locked: null,
        sentryEnabled: null,
        lowPowerMode: null,
        keepAccessoryPower: null,
        valetMode: null,
        speedLimitMode: null,
        speedLimitMph: null,
        ...
        rightFrontWindowOpen: null,
        leftRearWindowOpen: null,
